...
eHealth solutions to the benefit of healthcare systems and thus citizens. Some examples include \textit{ePrescriptions} and
...
to study the feasibility of practical use of such API as an implementation of an integration platform to collect data
