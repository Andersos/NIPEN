...
This report was commissioned to describe the design and implementation of a National Integration Platform prototype
for Citizen Centric eHealth in Norway. Recent years have seen a strong momentum to the development of large-scale
eHealth solutions to the benefit of health care systems and thus citizens. Some examples include \textit{ePrescriptions} and
the web portal \textit{helsenorge.no} for citizen centric health. In future years, eHealth will definitely have a key role
in making health care systems more efficient, interoperable and ubiquitous. However national eHealth projects have
...
and consumers behavior by taking advantage of electronic devices such as smartphones and tables.
These devices are becoming more and more widespread and cheap and can already be
used to monitor users' health using a number of applications, a trend called \textit{self-quantification}.
...
to study the feasibility of practical use of such API to implement integration platform which is able to collect data
from various sources like mobile devices and existing third party solutions like Microsoft HealthVault.
 
The perspective which we analyze is twofold: on one side we are interested in the feasibility of such integration
platform using the chosen approach. On the other side we examine the practical scenario from a third party
...
The project was commissioned by The Directorate of Health, Department of the Health Portal.

The group consisted of three students from NTNU.
The group would like to thank Meng Zhu for his advices, extensive feedback and supervision.
We would also like to thank the customer representative Mr. Helge T. Blindheim for proposing such an interesting
project which we enjoyed working on and for his precious feedback.% and great guidance.
}
\clearpage % Start a new page
