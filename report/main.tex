...
This report is for the main project in the course TDT4290 Customer Driven Project at NTNU. The team consisted of a three students from NTNU. 

The team would like to thank our supervisor Meng Zhu for his guidence, help and advice for this project. 

In addition we would also like to thank our customer Helsedirektoratet and their contact person Helge Blindheim. Say something about helge

Thank the people from usability tests valuable feedback
}
\clearpage % Start a new page
...
\textbf{NTNU} & \textbf{N}orges \textbf{T}eknisk-\textbf{N}aturvitenskalige \textbf{U}niversitet i Trondheim
