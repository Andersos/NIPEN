...
This section describes management rules and practices we put in use.% to ensure the quality of the product and the report.
...
It is possibile to export the data on Scrumdo to other formats such as Excel tables.
...
Google Drive had the advantage of being freely available and totally cross-platform. Furthermore, using Google Drive ensured that everyone had always access to the lastest version of the document.
