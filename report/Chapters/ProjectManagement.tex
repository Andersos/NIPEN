...
The project manager is also responsible of producing weekly status reports and supervisor relations.
\item[Product owner]
...
\begin{tabular}{ | l | l | }
  ...
  Member & Roles \\
  \hline\noalign{\smallskip}\noalign{\smallskip}\hline
  Anders Olsen Sandvik  &  System developer, Secretary\\
  Emanuele Di Santo     &  Project manager, Droid developer\\
