...
The weight application is an Android app that is able to fetch and push data to and from HealthVault,
as well as sending it over to NIPEN. This application was developed using one of the examples
...
When the application starts it redirects the user to HealthVault's page to authenticate.
