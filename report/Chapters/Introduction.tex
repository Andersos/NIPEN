...
This chapter provides a description of the project in section \ref{section:description},
of the client in section \ref{section:client}, of the parties involved in the project in section \ref{section:parties} and in
its background and goals in sections \ref{section:background} and \ref{section:objective} respectively.
The project duration is stated in section \ref{section:duration}.
...
The Directorate has, among other, the task of digitalizing Norway's health care system by providing services for both specialists and citizens. The customer was represented by Mr. Helge T. Blindheim. His contact information is shown in table \ref{table:client}.  
...
The aim of the customer was to investigate the possibilities for national eHealth's projects to use widely available devices such as smartphones and tables. The customer was also interested in a prototype system that could demonstrate such possibilities and stimulate further work.
