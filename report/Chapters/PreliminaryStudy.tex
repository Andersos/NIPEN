...
The Waterfall development process is a classical model proposed in the early 70s.
...
need to be entirely completed. The \iffalse progress of the\fi project is seen as if 'flowing downwards'
...
% it can be hard for a system designer to predict future implementation difficulties of a type of design,
%hence the design of the system may change during the process.
