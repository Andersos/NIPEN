...
The Scrum approach could be described as both iterative and incremental.

It consists of multiple sprints, which last from two to four weeks.% depending on the size of the task.
