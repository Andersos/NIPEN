...
In this section we present the technologies we used in our project.
%We are going to go through what type of technologies we used for
%the server (back-end), web page (front-end), database and for the development of applications for mobile units. 
...
REST, is an acronym from Representational State Transfer and is basically a software architectural style where clients
...
\textbf{Simplicity}\newline
REST is simple and that is one big advantage over more complex standards.
...
SOAP makes heavy use of XML for communication.
There are some strict rules on how the XML data should be formatted.
