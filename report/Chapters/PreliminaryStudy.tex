...
Apps are used to populate a user's health record by collecting health measurements and parameters and make use of such information to provide services.
...
authorized to access weight and glucose measurements but not others (allergies, pregnancies\ldots).
