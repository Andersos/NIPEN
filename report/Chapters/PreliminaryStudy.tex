...
The services provides a good degree of availability and redundancy.
...
Additionally, all data is represented using standardized models and format (JSON) of which we present an example below.
...
The application computes an average \'redness\' value and uses that to detected heartbeats and calculate a beats per minute (BPM) measurement.
