...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.5]{../Figures/use-case-diagram-measure-and-view-heart-rate.png}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.5]{../Figures/use-case-diagram-send-heart-rate.png}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.5]{../Figures/use-case-diagram-view-weight.png}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.5]{../Figures/use-case-diagram-send-weight.png}
\end{center}
