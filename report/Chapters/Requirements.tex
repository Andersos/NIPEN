...
This chapter describes the requirements for the product. 
These include both functional and non-functional requirements.
We begin this chapter by presenting the stakeholders in section \ref{section:stakeholders}.
...
In section \ref{section:reqvalidation} we are going to go through the requirement validation and in section \ref{section:usecases} we are going to show some use cases.
Section \ref{section:testplan} contains a description of our test plan.
