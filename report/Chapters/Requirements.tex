...
Functional requirements will be given for our applications.
The applications consists of: an integration platform (NIPEN), a heart rate and two weight applications that are able to send values to NIPEN, and a front-end (i.e. a web page) that is capable of visualizing the data stored in the integration platform.
...
\begin{tabular}{ | r | p{11.5cm} | }
  ...
  \hline\noalign{\smallskip}\noalign{\smallskip}\hline
  FIP1	& NIPEN shall support API endpoints for receiving
          heart rate data models expressed as JSON strings.		& Med	& High \\
  FIP2	& NIPEN shall support API endpoints for receiving
          weight data models expressed as JSON strings.				& Med	& High \\
  FIP3	& NIPEN shall support API endpoints for forwarding
          stored heart rate measurements as JSON models.			& Med	& High \\
  FPI4	& NIPEN shall support API endpoints for forwarding
