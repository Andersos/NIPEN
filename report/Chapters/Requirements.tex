...
\begin{tabular}{ | r | p{11.5cm} | }
  ...
  \textbf{Description}  & The application shall forward weight measurements to the IP using the web API. \\
  \textbf{Complexity}   & Low \\
  \textbf{Priority}     & High \\
...
The section consists of use cases for the front-end, heart rate application, weight application and the HealthVault integration service.
...
\begin{tabular}{ l | p{10cm} }
  ...
  Description & Display the data from the integration platform for the user. \\ \hline
...
\begin{tabular}{ l | p{10cm} }
  ...
  Actor & User and Integration Platform \\ \hline
  Precondition &
    \par 1. The integration platform is online.
