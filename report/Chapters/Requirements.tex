...
Stakeholders are described in section \ref{section:stakeholders}.
...
Section \ref{section:reqvalidation} examines some requirement validation criterias.
Uses cases are presented in section \ref{section:usecases}.
...
\begin{tabular}{ | c | p{12.5cm} | }
  ...
  Low & The requirement is easy and can be achieved in a short amount of time. (10 hours or less) \\
  \hline
\end{tabular}
\end{center}
